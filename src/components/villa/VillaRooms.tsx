...
const rooms = [
  ...
  },
  {
    ...
    details: ['Doccia ampia', 'WC e bidet', 'Scaldasalviette', 'Asciugamani inclusi'],
    badge: 'Bagno',
  },
  {
    ...
    details: ['Piano cottura gas', 'Forno e microonde', 'Lavastoviglie', 'Lavatrice', 'Tavolo 6-8 posti'],
    badge: 'Cucina',
  },
  {
    name: 'Soggiorno',
    ...
    details: ['Divano ampio', 'TV Smart', 'Aria condizionata', 'Accesso al balcone', 'Decorazioni naturali'],
    badge: 'Soggiorno',
  },
];
